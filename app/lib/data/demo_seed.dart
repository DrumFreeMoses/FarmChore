...
const List<RoleDefaultSet> farmDefaults = [
  ...
  RoleDefaultSet(
    ...
    chores: [
      ChoreDefault(title: 'Fix fence', weekdays: [1, 4]),
      ChoreDefault(title: 'Equipment repair', weekdays: [2, 5]),
      ChoreDefault(title: 'Sharpen tools', weekdays: [3]),
      ChoreDefault(title: 'Tractor & vehicle check', weekdays: [6]),
    ],
  ),
  RoleDefaultSet(
    role: FarmRole.farmers,
    chores: [
      ChoreDefault(title: 'Harvest vegetables in season', weekdays: [1, 3, 5]),
      ChoreDefault(title: 'Garden weeding & mulching', weekdays: [2, 4]),
      ChoreDefault(title: 'Grain & flour milling', weekdays: [6]),
      ChoreDefault(title: 'Comb honey & bees', weekdays: [5]),
    ],
  ),
  RoleDefaultSet(
    role: FarmRole.nonJsf,
    chores: [
      ChoreDefault(title: 'Restock Farm Store', weekdays: [1, 3, 5]),
      ChoreDefault(title: 'Clean & organize projects', weekdays: [2, 4]),
      ChoreDefault(title: 'Members pickup support', weekdays: [6]),
    ],
  ),
];
